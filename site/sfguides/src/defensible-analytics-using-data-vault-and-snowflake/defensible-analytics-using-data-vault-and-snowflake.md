...
Data are assets, relevant to our decision-making processes, and when transformed into information can reduce the effort of decision-making, while also increasing the quality, speed, and execution of our decisions. Improving decision effectiveness improves the performance of our enterprise for all stakeholders. Knowing that, how do we manage information appropriately?

### What is Data Vault?

In 2018, at the World-Wide Data Vault Consortium (WWDVC), [Bill Inmon](https://en.wikipedia.org/wiki/Bill_Inmon) refreshed his classic definition of the Data Warehouse.
...
On the very right we have our ultimate **information consumers**: business users, AI agents, data scientists, IT systems or even other companies you decide to share your data with.
